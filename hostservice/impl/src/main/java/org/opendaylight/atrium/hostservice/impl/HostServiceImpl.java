...
public class HostServiceImpl implements HostService, AutoCloseable,
        BindingAwareProvider, HostUpdatesListener, AddressUpdateListener {
    ...
    class AddressTracker {
        private ConcurrentHashMap<IpAddress, Addresses> addressStore;
        
        public AddressTracker() {
            addressStore = new ConcurrentHashMap<>();
        }
        
        public void addAddress(IpAddress ip, Addresses address) {
        ...
        public void updateAddress(IpAddress ip, Addresses address) {
            synchronized(addressStore) {
        ...
        public Addresses getAddress(IpAddress ip) {
