 ...
 */
public final class AtriumIp6Prefix extends AtriumIpPrefix {
    public static final AtriumIpAddress.Version VERSION = AtriumIpAddress.Version.INET6;
    // Maximum network mask length
    public static final int MAX_MASK_LENGTH = AtriumIpPrefix.MAX_INET6_MASK_LENGTH;
     ...
     */
    private AtriumIp6Prefix(AtriumIp6Address address, int prefixLength) {
     ...
     */
    public AtriumIp6Address address() {
        AtriumIpAddress a = super.address();
        return (AtriumIp6Address) a;
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIp6Prefix valueOf(byte[] address, int prefixLength) {
        return new AtriumIp6Prefix(AtriumIp6Address.valueOf(address), prefixLength);
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIp6Prefix valueOf(AtriumIp6Address address, int prefixLength) {
        return new AtriumIp6Prefix(address, prefixLength);
    }
     ...
     */
    public static AtriumIp6Prefix valueOf(String address) {
        ...
        AtriumIp6Address ipAddress = AtriumIp6Address.valueOf(parts[0]);
        int prefixLength = Integer.parseInt(parts[1]);

        return new AtriumIp6Prefix(ipAddress, prefixLength);
    }
}
