 ...
 */
public final class AtriumIp4Prefix extends AtriumIpPrefix {
    public static final AtriumIpAddress.Version VERSION = AtriumIpAddress.Version.INET;
    // Maximum network mask length
    public static final int MAX_MASK_LENGTH = AtriumIpPrefix.MAX_INET_MASK_LENGTH;
     ...
     */
    private AtriumIp4Prefix(AtriumIp4Address address, int prefixLength) {
     ...
     */
    public AtriumIp4Address address() {
        AtriumIpAddress a = super.address();
        return (AtriumIp4Address) a;
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIp4Prefix valueOf(int address, int prefixLength) {
        return new AtriumIp4Prefix(AtriumIp4Address.valueOf(address), prefixLength);
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIp4Prefix valueOf(byte[] address, int prefixLength) {
        return new AtriumIp4Prefix(AtriumIp4Address.valueOf(address), prefixLength);
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIp4Prefix valueOf(AtriumIp4Address address, int prefixLength) {
        return new AtriumIp4Prefix(address, prefixLength);
    }
     ...
     */
    public static AtriumIp4Prefix valueOf(String address) {
        ...
        AtriumIp4Address ipAddress = AtriumIp4Address.valueOf(parts[0]);
        int prefixLength = Integer.parseInt(parts[1]);

        return new AtriumIp4Prefix(ipAddress, prefixLength);
    }
}
