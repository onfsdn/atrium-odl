 ...
 */
public final class AtriumIp4Address extends AtriumIpAddress {
    public static final AtriumIpAddress.Version VERSION = AtriumIpAddress.Version.INET;
    public static final int BYTE_LENGTH = AtriumIpAddress.INET_BYTE_LENGTH;
    public static final int BIT_LENGTH = AtriumIpAddress.INET_BIT_LENGTH;
     ...
     */
    private AtriumIp4Address(byte[] value) {
        super(VERSION, value);
    }
     ...
     */
    public static AtriumIp4Address valueOf(int value) {
        byte[] bytes =
            ByteBuffer.allocate(INET_BYTE_LENGTH).putInt(value).array();
        return new AtriumIp4Address(bytes);
    }
     ...
     */
    public static AtriumIp4Address valueOf(byte[] value) {
        return new AtriumIp4Address(value);
    }
     ...
     * @throws IllegalArgumentException if the argument is invalid
     */
    public static AtriumIp4Address valueOf(InetAddress inetAddress) {
     ...
     * @throws IllegalArgumentException if the argument is invalid
     */
    public static AtriumIp4Address makeMaskPrefix(int prefixLength) {
        byte[] mask = AtriumIpAddress.makeMaskPrefixArray(VERSION, prefixLength);
        return new AtriumIp4Address(mask);
    }
     ...
     */
    public static AtriumIp4Address makeMaskedAddress(final AtriumIp4Address address,
                                               int prefixLength) {
        byte[] net = makeMaskedAddressArray(address, prefixLength);
        return AtriumIp4Address.valueOf(net);
    }
}
