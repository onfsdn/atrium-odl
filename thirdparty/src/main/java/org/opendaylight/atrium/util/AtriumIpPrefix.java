 ...
 * </p>
 */
public class AtriumIpPrefix {
    // Maximum network mask length
    public static final int MAX_INET_MASK_LENGTH = AtriumIpAddress.INET_BIT_LENGTH;
    public static final int MAX_INET6_MASK_LENGTH = AtriumIpAddress.INET6_BIT_LENGTH;
     ...
     */
    protected AtriumIpPrefix(AtriumIpAddress address, int prefixLength) {
        checkPrefixLength(address.version(), prefixLength);
        this.address = AtriumIpAddress.makeMaskedAddress(address, prefixLength);
    ...
    /**
     * Gets the {@link AtriumIp4Prefix} view of the IP prefix.
     *
     * @return the {@link AtriumIp4Prefix} view of the IP prefix if it is IPv4,
     * otherwise null
     */
    public AtriumIp4Prefix getIp4Prefix() {
        if (!isIp4()) {
            return null;
        }

        // Return this object itself if it is already instance of Ip4Prefix
        if (this instanceof AtriumIp4Prefix) {
            return (AtriumIp4Prefix) this;
        }
        return AtriumIp4Prefix.valueOf(address.getIp4Address(), prefixLength);
    }

    /**
     * Gets the {@link AtriumIp6Prefix} view of the IP prefix.
     *
     * @return the {@link AtriumIp6Prefix} view of the IP prefix if it is IPv6,
     * otherwise null
     */
    public AtriumIp6Prefix getIp6Prefix() {
        if (!isIp6()) {
            return null;
        }

        // Return this object itself if it is already instance of Ip6Prefix
        if (this instanceof AtriumIp6Prefix) {
            return (AtriumIp6Prefix) this;
        }
        return AtriumIp6Prefix.valueOf(address.getIp6Address(), prefixLength);
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIpPrefix valueOf(int address, int prefixLength) {
        return new AtriumIpPrefix(AtriumIpAddress.valueOf(address), prefixLength);
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIpPrefix valueOf(AtriumIpAddress.Version version, byte[] address,
                                   int prefixLength) {
        return new AtriumIpPrefix(AtriumIpAddress.valueOf(version, address), prefixLength);
    }
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    public static AtriumIpPrefix valueOf(AtriumIpAddress address, int prefixLength) {
        return new AtriumIpPrefix(address, prefixLength);
    }
     ...
     */
    public static AtriumIpPrefix valueOf(String address) {
        ...
        AtriumIpAddress ipAddress = AtriumIpAddress.valueOf(parts[0]);
        int prefixLength = Integer.parseInt(parts[1]);

        return new AtriumIpPrefix(ipAddress, prefixLength);
    }
     ...
     * otherwise false
     */
    public boolean contains(AtriumIpPrefix other) {
        ...
        //
        AtriumIpAddress maskedAddr =
            AtriumIpAddress.makeMaskedAddress(other.address, this.prefixLength);
     ...
     * false
     */
    public boolean contains(AtriumIpAddress other) {
        if (version() != other.version()) {
            return false;
        }
        ...
        //
        AtriumIpAddress maskedAddr =
            AtriumIpAddress.makeMaskedAddress(other, this.prefixLength);
        return this.address.equals(maskedAddr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj == null) || (!(obj instanceof AtriumIpPrefix))) {
            return false;
        }
        AtriumIpPrefix other = (AtriumIpPrefix) obj;
     ...
     * @throws IllegalArgumentException if the prefix length value is invalid
     */
    private static void checkPrefixLength(AtriumIpAddress.Version version,
                                          int prefixLength) {
        int maxPrefixLen = 0;
